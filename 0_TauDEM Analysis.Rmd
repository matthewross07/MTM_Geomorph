...
#New Infinity
mpiexec -n 7 moveoutletstostrm -p newinffdr.tif -src new100inf.tif -o data/in/shapefile/approxnew.shp -om data/in/shapefile/snapinfnew.shp -md 30
...
I used this network to hand select watershed outlets based on a separate layer of mining extent. I tried to capture watersheds that were > 90% mined. 
...
gdal_polygonizeR <- function(x, outshape=NULL, gdalformat = 'ESRI Shapefile',
  ...
  if (is.null(pypath)) {
    pypath <- Sys.which('/Library/Frameworks/GDAL.framework/Versions/2.1/Programs/gdal_polygonize.py')
  }
...
shd.shp.buf <- gBuffer(shd.shp,width=400) %>%
