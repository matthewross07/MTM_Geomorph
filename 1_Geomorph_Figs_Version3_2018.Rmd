...
boundary <- st_envelope(st_buffer(watersheds,1000))


#No idea why the extent object wouldn't work. 
e2010 <- raster('data/in/TauNew.tif') %>%
  crop(.,extent(414446,459186,4155384,4218224))
...
ggplot() + 
  geom_tile(data=eobj,aes(x=x,y=y,fill=TauNew))
    geom_sf(data=wv.sub,fill='gray') 
  theme_few(base_size=16) + 
  theme(panel.grid.major = element_line(color='transparent')) +
  geom_sf(data=watersheds,aes(fill=Type),fill=NA,size=1) 
  scale_fill_manual(values=c('Red','Orange3'),name='')
